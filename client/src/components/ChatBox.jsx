...
//   useEffect(() => {
//     if (!isAdmin) return;
//     // Hardcoded: Fetch a student ID (simulate)
//     API.post("/auth/sync-user", { clerkId: "hardcoded-student-id" }).then(
//       (res) => {
...
//       <div className="h-40 overflow-y-scroll border mb-2 p-2 bg-gray-100">
...
//       />
//       <button onClick={sendMessage} className="bg-blue-500 text-white px-4 py-1">
//         Send
//       </button>
//     </div>
//   );
